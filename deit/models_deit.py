...
class MultiResoPatchEmbed(nn.Module):
    ...
    def __init__(self, img_size_list=[112, 224], patch_size=16, in_chans=3, embed_dim=196):
        super().__init__()
...
class LFVisionTransformer(nn.Module):
    ...
    def __init__(self, img_size_list=[112, 224], patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 num_heads=12, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop_rate=0., attn_drop_rate=0., region_size=5,
        ...
        self.region_size = region_size if self.image_size == 224 else 8
    ...
    def forward(self, xx):
        ...
        if True:
            ...
            important_index, unimportan_tokens = block_information(cls_attn, embedding_x1, self.alpha, self.region_size, self.image_size)
